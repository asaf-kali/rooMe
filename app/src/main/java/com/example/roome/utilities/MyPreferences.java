...
public class MyPreferences {
     ...
     */
    public static void setManualFirstName(Context context, String firstName) {
        final SharedPreferences reader = getSharedPreferences(context);
        final SharedPreferences.Editor preferencesEditor = reader.edit();
     ...
     */
    public static void setManualLastName(Context context, String lastName) {
        final SharedPreferences reader = getSharedPreferences(context);
        final SharedPreferences.Editor preferencesEditor = reader.edit();
     ...
     * @param context - app context
     */
    public static void setIsRoommateSearcherToFalse(Context context) {
        final SharedPreferences reader = getSharedPreferences(context);
        final SharedPreferences.Editor preferencesEditor = reader.edit();
     ...
     */
    public static boolean isRoommateSearcher(Context context) {
        final SharedPreferences reader = getSharedPreferences(context);
