...
import com.example.roome.activities.MainActivityApartmentSearcher;
import com.example.roome.utilities.UsersImageConnector;
import com.example.roome.utilities.FirebaseMediate;
import com.example.roome.utilities.MyPreferences;
import com.example.roome.R;
import com.example.roome.models.ApartmentAdditionalInfo;
...
//        setFirebaseListeners();  //todo include this line
    ...
    private void handlingRightCardExit() {
        ...
        if (MyPreferences.isFirstLike(getContext())) {
            AlertDialog.Builder dialog = new AlertDialog.Builder(getActivity());
            dialog.setTitle("Want to see more apartments like this one?");
            dialog.setMessage("edit your filters and profile!");
